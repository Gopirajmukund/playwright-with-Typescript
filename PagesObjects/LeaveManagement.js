...
exports.Leavemanagement = class Leavemanagement {
    ...
    constructor(page) {
        ...
        this.leaveApprovedTostMessage = this.page.locator("//div[text()='Leave Applied Successfully']")
    ...
    async VarifyleaveApplyToastmMessage(){
        const element =  await this.leaveApprovedTostMessage.textContent()
        console.log("Leave approved Toast Message :", element)
        expect(element).toMatch("Leave Applied Successfully")
    }
}
